...
class Home extends React.Component {
    ...
    return (
      <div className="Home container">
        ...
        <p className="hurst-beginnings align-left">James Hurst worked in the mines to save enough money to purchase the farm and then built the home pictured below.</p>
